...
pub mod s_rgb_paint {
    ...
    pub fn burn_pixels_six(ctx: Context<BurnPixelsSix>) -> Result<()> {
        ix::paint::burn::six::ix(ctx)
    }

    pub fn burn_pixels_seven(ctx: Context<BurnPixelsSeven>) -> Result<()> {
        ix::paint::burn::seven::ix(ctx)
    }
}
...
pub struct BurnPixelsSix<'info> {
    ...
    pub pixel_five: Box<Account<'info, Pixel>>,
    #[account(
    address = proof.burned.plan.six.as_ref().unwrap().pda
    )]
    pub pixel_six: Box<Account<'info, Pixel>>,
    // cpi accounts
    #[account(mut,
    address = pixel_one.mint
    )]
    ...
    pub pixel_five_mint_ata: Box<Account<'info, TokenAccount>>,
    #[account(mut,
    address = pixel_six.mint
    )]
    pub pixel_six_mint: Box<Account<'info, Mint>>,
    #[account(mut,
    associated_token::mint = pixel_six_mint,
    associated_token::authority = payer,
    )]
    pub pixel_six_mint_ata: Box<Account<'info, TokenAccount>>,
    #[account(mut,
    address = proof.nft.mint
    )]
    pub mint: Box<Account<'info, Mint>>,
...
#[derive(Accounts)]
pub struct BurnPixelsSeven<'info> {
    // pda
    #[account(mut,
    seeds = [
    pda::paint::proof::SEED.as_bytes(),
    ...
    pub pixel_six: Box<Account<'info, Pixel>>,
    #[account(
    address = proof.burned.plan.seven.as_ref().unwrap().pda
    )]
    pub pixel_seven: Box<Account<'info, Pixel>>,
    // cpi accounts
    #[account(mut,
    address = pixel_one.mint
    )]
    ...
    pub pixel_six_mint_ata: Box<Account<'info, TokenAccount>>,
    #[account(mut,
    address = pixel_seven.mint
    )]
    pub pixel_seven_mint: Box<Account<'info, Mint>>,
    #[account(mut,
    associated_token::mint = pixel_seven_mint,
    associated_token::authority = payer,
    )]
    pub pixel_seven_mint_ata: Box<Account<'info, TokenAccount>>,
    #[account(mut,
    address = proof.nft.mint
    )]
    pub mint: Box<Account<'info, Mint>>,
